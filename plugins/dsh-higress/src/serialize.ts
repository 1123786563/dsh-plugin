...
function resolveThinking(options: GenerateOptions, defaults: RequestDefaults): ResolvedThinking {
  ...
  // The branded ReasoningEffortId is opaque at the type level; every value this
  // adapter's vocabulary reaches here with is one of low/high/max ('off' above).
  return { thinking: 'enabled', reasoningEffort: effort as 'low' | 'high' | 'max' }
}
